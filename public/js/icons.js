// Inline Lucide icons (lucide.dev, ISC license). Inner markup only —
// iconSvg() wraps it in the shared <svg> shell so stroke style stays
// uniform. Sized via CSS (`svg.icon`), colored via currentColor.
const ICONS = {
...
// name on the button itself (needed where the icon changes with state,
// e.g. stopwatch Start/Lap/Rest, runner Next/Finish).
